...
--
-- Host: localhost:3306
-- Generation Time: Jun 04, 2021 at 10:11 AM
...
(23, 'Manage Roles', 'Admin', 0, 0, 'fa fa-american-sign-language-interpreting', 'setting/manage-roles/', 19, 1),
...
(31, 'Manage Admin', 'Admin', 0, 0, 'fa fa-list', 'signup/admins/', 23, 1),
(32, 'Manage Products', '(Admin)', 0, 0, 'flaticon2-line-chart', 'product/index/', 2, 1),
(33, 'Manage Brands', '(Admin)', 0, 0, 'fa fa-tag', 'brand/index/', 3, 1),
(34, 'Site Settings', '(Admin / User)', 0, 0, 'fa fa-cog', 'setting/', 14, 1),
(35, 'Manage Meta Tag', '(Admin / User)', 34, 0, 'fa fa-cog', 'setting/manage-meta-tag', 1, 1),
(37, 'Pages', '(Admin / User)', 38, 0, 'fa fa-page', 'setting/pages', 1, 1),
(38, 'Manage Pages', '(Admin / User)', 0, 0, 'fa fa-file', 'setting/pages', 13, 1),
(39, 'Admins', '(Admin / User)', 31, 0, 'fa fa-store', 'signup/admins/', 1, 1),
...
(42, 'Manage Banners', '(Admin / User)', 0, 0, 'fa fa-file', 'setting/banners', 12, 1),
(44, 'Manage Front User', '(Admin)', 0, 0, 'fa fa-cog', 'front_user', 22, 1),
(45, 'Manage Social Icon', 'User', 34, 0, 'fa fa-setting', 'setting/manage_social_icon', 3, 1),
(46, 'Manage Social Icon', 'Admin', 0, 0, 'fa fa-icons', 'manage_social_icon', 19, 1),
(47, 'Manage Email Template', 'Admin', 0, 0, 'fa fa-envelope', 'email-templates', 21, 1),
(48, 'Manage Order', 'Admin', 0, 0, 'fa fa-shopping-cart', 'order', 16, 1),
(49, 'Manage Youtube Link', 'Admin', 0, 0, 'fa fa-credit-card', 'social_links', 8, 1),
(50, 'Manage Newsletter', 'Admin', 0, 0, 'fa fa-list', 'newsletter', 20, 1),
(51, 'Auto Product', '(Admin/User)', 32, 0, 'fa fa-icons', 'product/index', 1, 1),
(52, 'Manual Product', '(Admin/User)', 32, 0, 'fa fa-plus', 'product/manual', 2, 1),
(53, 'Manage Category', 'Admin', 0, 0, 'fa fa-american-sign-language-interpreting', 'category', 4, 1),
(54, 'Manage Country', 'Admin', 0, 0, 'fa fa-file', 'country', 18, 1),
(55, 'Manage Shop', 'Admin', 0, 0, 'fa fa-list', 'shop', 10, 1),
(56, 'Manage Page Item', 'Admin', 38, 0, 'fa fa-plus', 'setting/manage_page_item', 2, 2);
...
(1, 'Admin', 'for admins only', '1,32,51,52,33,53,46,44,31,39,30,47,48,49,50,55,54,23,27,24,28,25,38,37,56,42,41,34,40,35,29', 1);
...
(1, 'waleed khalid', 'Alaska (AK)', '', 0, '91897', '2020-06-15 20:04:45', '2021-04-30 19:11:56', 1, 0);
...
INSERT INTO `tbl_user_bank_details` (`id`, `account_no`, `branch_code`, `bank_name`, `user_id`) VALUES
(1, '5643', '564340100', 'Alfalah', 1);
