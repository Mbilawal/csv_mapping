							...
							<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
								...
								<form class="kt-form" id="kt_form">
									...
									<div class="kt-wizard-v1__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
										<div class="kt-heading kt-heading--md">Setup Your New Role</div>
										<div class="kt-form__section kt-form__section--first">
											<div class="kt-wizard-v1__form">
												<div class="form-group">
													<label>Name</label>
													<input type="text" class="form-control role_name" name="role_name" placeholder="Admin / User" value="">
													<span class="form-text text-muted">Please enter role name.</span>
												</div>
												<div class="form-group">
													<label>Description</label>
													<input type="text" class="form-control role_description" name="role_description" placeholder="For users / admin" value="">
													...
													<div class="row menus_list">
														<div class="col-xl-4">
															<label class="kt-checkbox kt-checkbox--solid kt-checkbox--success">
																<input type="checkbox" class="check-all permissions" name="permissions" value="<?php echo $parent_menu['id']; ?>">
																...
																?>
																	<div class="col-md-4">
																		<label class="kt-checkbox kt-checkbox--bold kt-checkbox--success">
																			<input type="checkbox" class="permissions" name="permissions" value="<?php echo $row['id']; ?>" data-id="<?php echo $parent_menu['id']; ?>">
